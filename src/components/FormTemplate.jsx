...
function FormTemplate({title, desc1, desc2, formType, formImage, setIsLoggedIn}) {
  return (
    <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
        ...
        <div className='relative w-11/12 max-w-[450px] '>
            ...
            <img src={formImage} width={558} height={504} loading='lazy' className='absolute -top-4 right-4'/>
        </div>
